...
public class Fragment_main extends Fragment {
    ...
    private void populateButtons(String userType, View view, String favorite) {
        ...
        if ("client".equals(userType)) {
            ...
            if(favorite != null) {
                buttonList.add(new ButtonItem("My Barber", R.drawable.ic_personal, ContextCompat.getColor(requireContext(), R.color.green), R.id.action_fragment_main_to_new_apointment));
            }
